...
echo "Updating the SBR Panel on Commit"
document_root=$1
git_branch=$2
cd $document_root
...
check_last_command_execution "SBR Panel Updated Successfully" "SBR Panel Update Failed.Exit the script"
composer install --no-interaction
check_last_command_execution "Composer Installed Successfully" "Composer Installation Failed.Exit the script"
php artisan migrate
check_last_command_execution "Artisan Migrate Successfully" "Artisan Migrate Failed.Exit the script"
...
################### Start Script ##################
echo -e "\e[1;43mWelcome to SBR Panel Installation with LAMP\e[0m"
