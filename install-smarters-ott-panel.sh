...
git clone -b $git_branch https://x-token-auth:$git_access_token@bitbucket.org/techsmarters8333/smarters-ott-panel-released.git .
check_last_command_execution "Smarters OTT Panel Cloned Successfully" "Smarters OTT Panel Cloning Failed"
}
